...
class MoviesData{
  static List<Movie> favData = List<Movie>();
  static List<String> error;
    ...
    static addFavData(Movie movie){
      if(favData.contains(movie)){
        error.add("Already Existed");
      }else{
        favData.add(movie);
      }

    }
    static List<Movie> getFavData(){
      if(favData == null){
        //
      }else{
        return favData;
    ...
    static bool removeData(Movie movie){
      if(favData.contains(movie)){
        favData.remove(movie);
        return true;
      }else{
        return false;
      }
